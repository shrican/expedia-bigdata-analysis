 ...
 * 
 *         Map reduce program to find to the most popular hotel clusters that
 *         were booked
 * 
 */
public class HotelClusterBookingsAnalysis {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setMapperClass(HotelClusterBookingsAnalysisMapper.class);
		job.setMapOutputValueClass(LongWritable.class);
		job.setMapOutputKeyClass(Text.class);

		job.setCombinerClass(HotelClusterBookingsAnalysisReducer.class);
		job.setReducerClass(HotelClusterBookingsAnalysisReducer.class);
	 ...
	 *
	 */
	public static class HotelClusterBookingsAnalysisMapper extends Mapper<LongWritable, Text, Text, LongWritable> {
	 ...
	 *
	 */
	public static class HotelClusterBookingsAnalysisReducer extends Reducer<Text, LongWritable, Text, LongWritable> {
